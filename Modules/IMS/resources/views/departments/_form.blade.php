    ...
    <div class="col-md-3">
        <div class="form-group">
            <div class="form-line">
                ...
                {!! Form::text('code', isset($department->id)? request()->old('code'): $code, [
                    'id' => 'code',
                    'class' => 'form-control',
                    'required' => 'required',
    ...
    <div class="col-md-3">
        <div class="form-group">
            <div class="form-line">
                ...
                {!! Form::Select('status',array('active'=>'Active','inactive'=>'Inactive'),Request::old('status'),['id'=>'dep_status', 'class'=>'form-control select2']) !!}
                {!! $errors->first('status') !!}
            </div>
        </div>
    </div>
