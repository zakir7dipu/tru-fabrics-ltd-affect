                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        @if(isOptionPermitted('department-create'))
                                            <a href="{{route('departments.create')}}" class="btn btn-info mb-2 me-2"
                                               data-toggle="tooltip" title="Add New Department"> <i class="mdi mdi-plus
                                           me-1"></i>{{translate('Add New Department')}}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
