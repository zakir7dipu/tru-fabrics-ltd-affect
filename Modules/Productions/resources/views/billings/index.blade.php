...
@section('javascript')
    ...
    <script>
        ...
        function showDetails(id) {
            $('#showUserDetailsModal .modal-title').html('Billings Details');
            $('#dataBody').empty().load('{{ url(Request()->route()->getPrefix().'/billings') }}/' + id);
            $('#showUserDetailsModal').modal('show');
        }
    </script>
@endsection
