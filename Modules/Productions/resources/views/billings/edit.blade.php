                        ...
                        <div class="card-body">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        {!! Form::model($billing, [
                                            'route' => ['billings.update', $billing->id],
                                            'method' => 'PUT',
                                                        ...
                                                        <select name="work_order_id"
                                                            ...
                                                            @if(isset($workOrders))
                                                                ...
                                                                @foreach($workOrders as $key => $workOrder)
                                                                    ...
                                                                    {{--//                                                                        foreach ($workOrder->finishedGoodsDeliveries as $item) {--}}
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="{{ $workOrder->id }}" {{$workOrder->id===$billing->work_order_id?'selected':''}}>{{ $workOrder->work_order_no }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="export_lc_no" class="form-control"
                                                               id="export_lc_no" value="{{$billing->export_lc_no}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <span class="text-danger">*</span>
                                                        {!! Form::date('submit_date', date('Y-m-d', strtotime($billing->submit_date)), [
                                                            'id' => 'submit_date',
                                                            'class' => 'form-control',
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {!! Form::number('discrepancies_charge', $billing->discrepancies_charge, [
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {!! Form::number('bank_charge_ait', $billing->bank_charge_ait, [
                                                            'id' => 'bank_charge_ait',
                                                            'class' => 'form-control mask-money',
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {!! Form::number('realized_value',$billing->realized_value, [
                                                            'id' => 'realized_value',
                                                            'class' => 'form-control mask-money',
                                                    ...
                                                    <input type="hidden" id="post_realized" name="post_realized">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {!! Form::number('short_realized_amount', $billing->short_realized_amount, [
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {!! Form::text('freight_charge', request()->old('freight_charge'), [
                                                            'id' => 'freight_charge',
                                                            'class' => 'form-control mask-money',
                                                        ...
                                                        <select name="status" id="status" class="form-control select2">
                                                            @if(isset($statuss))
                                                                @foreach($statuss as $key => $value)
                                                                    <option
                                                                        value="{{ $key }}" {{$key==$billing->status?'selected':''}}>{{ $value }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function getWorkOrderItems(element) {
            ...
            $('#finished_goods_delivery_id').html('<option value="">Please Wait...</option>').empty().load('{{URL::to(Request()->route()->getPrefix()."/billings/load-wo-wise-fg-references")}}/' + element.find(':selected').val() + '?finished_goods_docs_id=' + {{$billing->id}});
