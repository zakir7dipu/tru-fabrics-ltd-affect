...
<div class="modal fade bd-example-modal-md" id="categoryUploadModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="dataBody">
                <form id="brandForm" enctype="multipart/form-data" action="{{route('categories.import-excel')}}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <a href="{{URL::to('excel/category-sample.xlsx')}}" download
