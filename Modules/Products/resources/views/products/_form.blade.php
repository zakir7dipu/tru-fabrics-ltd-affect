<div class="row">
                ...
                @foreach($attributes as $key => $attribute)
                    <div class="col-md-3 mt-1 attributes attribute-{{ $attribute->id }}"
                        ...
                        <div class="input-group input-group-md">
                            <select name="attribute_option_id[{{ $attribute->id }}]"
    ...
    <div class="col-md-12 mt-2">
        {!! Form::submit('Save changes', ['class' => 'btn btn-primary pull-right font-10','data-placement'=>'top','data-content'=>'click save changes button for save role information']) !!}
        &nbsp;
    </div>
</div>
