                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="row">
                                    <form action="{{ url('admin/report/realization-due-statement') }}" method="get"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 pt-2">
                                                    @include('report-buttons', [
                                                        'url' => url('admin/report/realization-due-statement')
                                                    ])
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @if(request()->get('type') == 'search')
                        <div class="card card-info mt-2 p-2">
                            <div class="row">
                                <div class="col-md-12">
                                    @include('report::realizationDueStatement.report')
                                </div>
                            </div>
                        </div>
                    @endif
