            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="row">
                                    <form action="{{ url('admin/report/greige-issuing') }}" method="get" accept-charset="utf-8" id="report-form" target="_parent">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 pt-2">
                                                    @include('report-buttons', [
                                                        'url' => url('admin/report/greige-issuing')
                                                    ])
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card card-info mt-2 p-2">
                        <div class="row">
                            <div class="col-md-12">
                                @include('report::issuingReceiving.report')
                            </div>
                        </div>
                    </div>
                    @endif
