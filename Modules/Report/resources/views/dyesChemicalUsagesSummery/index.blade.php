                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="row">
                                    <form action="{{ url('admin/report/dyes-chemical-uses-summery') }}" method="get"
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="lc_no" id="lc_no"
                                                        ...
                                                        @foreach($proformaInvoices as $lcNo)
                                                            <option
                                                                value="{{$lcNo->lc_no}}" {{request()->has('lc_no')?(request()->get('lc_no')==$lcNo->lc_no?'selected':''):''}}>{{$lcNo->lc_no}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3 pt-2">
                                                    @include('report-buttons', [
                                                        'url' => url('admin/report/dyes-chemical-uses-summery')
                                                    ])
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card card-info mt-2 p-2">
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    @include('report::dyesChemicalUsagesSummery.report')
                                </div>
                            </div>
                        </div>
                    @endif
