                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>{{translate('Departments')}}
                                                </strong></label>
                                            <div class="col-6">
                                                {!! Form::select('department_id', $departments,request()->old('department_id'), array('id'=>'department_id','class' => 'form-control select2','multiple'=>false,'required'=>true)) !!}

                                                @if ($errors->has('department_id'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('department_id') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>{{translate('Designation')}}
                                                </strong></label>
                                            <div class="col-6">
                                                {!! Form::select('designation_id', $designations,request()->old('designation_id'), array('id'=>'designation_id','class' => 'form-control select2','multiple'=>false,'required'=>true)) !!}

                                                @if ($errors->has('designation_id'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('designation_id') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('name'))
                                                    <span class="help-block">
                                                        <strong
                                                            class="text-danger">{{ $errors->first('name') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('phone'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('phone') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('email'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('email') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('password'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('password') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('confirm_password'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('confirm_password') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('avatar'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('avatar') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>{{translate('Assign Roles')}}
                                                    </strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('roles'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('roles') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>{{translate('Assign Departments')}}
                                                    </strong></label>
                                            <div class="col-6">
                                                {!! Form::select('departments[]', $departments,[], array('id'=>'select2-3','class' => 'form-control select2','multiple'=>true,'required'=>false)) !!}

                                                @if ($errors->has('departments'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('departments') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>{{translate('Assign Events')}}
                                                    </strong></label>
                                            <div class="col-6">
                                                {!! Form::select('events[]', $events,[], array('id'=>'select2-2','class' => 'form-control select2','multiple'=>true,'required'=>true)) !!}

                                                @if ($errors->has('events'))
                                                    <span class="help-block"><strong
                                                            class="text-danger">{{ $errors->first('events') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            @if ($errors->has('permission'))
                                                <span class="help-block"><strong
                                                        class="text-danger">{{ $errors->first('permission') }}</strong></span>
                                                <br>
                                            @endif
