                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('acl.users.index')}}" class="btn btn-info mb-2 me-2"
                                           data-toggle="tooltip" title="Users List"> <i
                                                class="mdi mdi-text me-1"></i>{{translate('Users Lists')}}</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <label class="slide_upload" for="file">
                                                    ...
                                                    @if(isset($user->avatar) && file_exists($user->avatar))
                                                        <img id="image_load" src="{{asset($user->avatar)}}"
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                {!! Form::select('departments[]', $departments,$user->assignDepartments->pluck('pivot.department_id')->all(), array('id'=>'select2-3','class' => 'form-control select2','multiple'=>false,'required'=>true)) !!}
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-6">
                                                {!! Form::select('events[]', $events,$user->assginNotificationEvents->pluck('pivot.notification_event_id')->all(), array('id'=>'select2-2','class' => 'form-control select2','multiple'=>true,'required'=>true)) !!}
                                        ...
                                        <strong class="text-danger">{{ $errors->first('permission') }}</strong>
                                                                    ...
                                                                    @foreach($chunk as $permission)
                                                                        <label>
                                                                            <input name="permission[]" type="checkbox"
                                                                                   value="{{ $permission->id }}"
                                                                                   class="name module-permissions-{{ $chunk_counter }} permissions" {{ in_array($permission->id, $userPermissions) ? 'checked' : '' }}>&nbsp;
                                                                            {{ $permission->name }}
                                                                        </label>
                                                                        <br/>
                                                                    @endforeach
                                            ...
                                            @if(isset($permissions[0]))
                                                @foreach($permissions as $key => $chunk)
                                                    ...
                                                    <div class="col-3">
                                                        <h5 class="">
                                                            <label for="check_all_permission-{{ $chunk_counter  }}"
                                                                   style="cursor: pointer">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6 offset-md-3">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="la la-check"></i>&nbsp;{{translate('Update User')}}
                                                </button>
                                                @can('user-list')
