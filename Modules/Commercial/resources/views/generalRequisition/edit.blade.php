                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('general-requisitions.index')}}" class="btn btn-info mb-2 me-2"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        {!! Form::model($requisition, [
                                            'route' => ['general-requisitions.update', $requisition->id],
                                            'method' => 'PUT',
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(addButton).click(function () {
                ...
                var fieldHTML = '<tr>\n' +
                    ...
                    '                                            <td>\n' +
                    '                                                <div class="input-group input-group-md mb-3 d-">\n' +
                    '                                                    <input type="number" name="qty[]" min="0"  id="qty_' + x + '" class="form-control requisition-qty" step="any" aria-label="Large" aria-describedby="inputGroup-sizing-sm" required data-quantity="">\n' +
                    '                                                </div>\n' +
                    '                                            </td>\n'
                    +
                    '\n' +
        ...
        function getProduct(element) {
            ...
            $.ajax({
                url: '{{URL::to(Request()->route()->getPrefix()."/general-requisitions/load-product")}}/' + subcategory_id + '?selected=' + selected_product + '&products_id=' + selectedProductIds,
                type: 'GET',
                data: {},
            })
