    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h4 class="modal-title " id="myLargeModalLabel">{{translate('Upload Opening Stock Data')}}</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body" id="dataBody">
                <form id="brandForm" enctype="multipart/form-data" action="{{route('proforma-invoices.import-excel')}}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <a href="{{URL::to('excel/opening-stock-sample.xlsx')}}" download
