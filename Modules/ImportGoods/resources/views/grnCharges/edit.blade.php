{!! Form::model($lcCharge, ['route' => ['grns.charges.update', $lcCharge->id],'method' => 'PUT','class' => 'form-horizontal','files' => false]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group">
            <div class="form-line">
                ...
                <span>{{$lcCharge->goodReceivedNote->reference_no}}</span>
                <input type="hidden" name="grn_id" value="{{$lcCharge->grn_id}}">
                {!! $errors->first('pi_no') !!}
            </div>
        </div>
    </div>
