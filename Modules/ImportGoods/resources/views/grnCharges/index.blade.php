...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            @include('components.breadcrumb', ['item' => ['/'=>languageValue(websiteSettings()->name),'admin/factory/gate-in-lists'=>'GRN Lists','active'=>'Commercial'],
            'pTitle' => $title])
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        @if(isOptionPermitted('grn-charge-create'))
                                            <a href="javascript:void(0)"
                                               data-src="{{route('grns.charges.create',$grn_id)}}"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-info">
                    <h4 class="modal-title" id="myLargeModalLabel">{{translate('GRN Details')}}</h4>
