    ...
    <div class="content">
        <div class="container-fluid">
            @include('components.breadcrumb', [
                'item' => ['/' => languageValue(websiteSettings()->name), 'admin/store/requisition-list' => 'Requisitions', 'active' => 'Delivery'],
                'pTitle' => $title,
            ])
            ...
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('requisition-list.index')}}" class="btn btn-info mb-2 me-2"
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                {!! Form::open(array('route' => 'requisition-list.store','method'=>'POST',
                                ...
                                <div class="row">
                                    ...
                                    {{--                                        <div class="form-group">--}}
                                    {{--                                            <div class="form-line">--}}
                                    {{--                                                {!!  Form::label('challan_no', 'Issue Challan No', ['class' => 'col-form-label']) !!}--}}
                                    {{--                                                <span class="text-danger">*</span>--}}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-line">
                                                {!!  Form::label('delivery_date', 'Issuing Date', ['class' => 'col-form-label']) !!}
                                                <span class="text-danger">*</span>
                                                ...
                                                @foreach($requisition->requisitionItems as $item)
                                                    ...
                                                    @if($item->qty != $deliveredQty)
                                                        ...
                                                        <tr id="SelectedRow{{$item->product_id}}">
                                                            ...
                                                            {{--                                                            <td class="text-center">{{$item->storeInventories->where('grnItem.expire_date', '>', date('Y-m-d'))->sum('qty')-$stockInventoryWiseDeliveryQty}}</td>--}}
