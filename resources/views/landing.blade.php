...
<head>
    <meta charset="utf-8"/>
    <title>{{websiteSettings()->name}} | LaraSoft </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title"
          content="theLaraSoft is an IT company based in Dhaka, Bangladesh which offers web design, web development, Ecommerce solutions & domain & hosting services in more than 5 countries."/>

    <meta name="keywords" content="best web design company in dhaka, best website development company in dhaka, ecommerce development company, best web design company in bangladesh, professional web design company,web application development,php developer,web app development
    ,hire php developer,web application development company,custom web application development,ecommerce web development,ecommerce website development,web application developers,web app development company,web application development services,ecommerce development,php web development,application developers,web app developers,web and app development,website application development,ecommerce web design,ecommerce web development company,web based application development,web development company,application development services,application development company,application development,web application company,ecommerce website design,ecommerce website development,ecommerce web design,ecommerce website,ecommerce development,ecommerce web development,ecommerce website builder,best ecommerce platform,best ecommerce sites,ecommerce solutions,e commerce sites,best ecommerce website builder,ecommerce store,
    best ecommerce websites,ecommerce web development company,top ecommerce platforms,ecommerce design,top ecommerce sites,create ecommerce website,best ecommerce platform 2021,ecommerce development company,ecommerce website development company,ecommerce website hosting,online ecommerce,shopping cart website,ecommerce website design,ecommerce website development,ecommerce web design,
    ecommerce website,ecommerce development,ecommerce web development,ecommerce website builder,best ecommerce platform,best ecommerce sites,ecommerce solutions,e commerce sites,best ecommerce website builder,ecommerce store,best ecommerce websites,ecommerce web development company,top ecommerce platforms,ecommerce design,top ecommerce sites,create ecommerce website,best ecommerce platform 2021ecommerce development company,ecommerce website development company,ecommerce website hosting,online ecommerce,shopping cart website,Software Design & Development,
    Comprehensive Software Systems,Software Company near You,Find Good Software Today,Competent Software Developers"/>
...
<nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
    <div class="container">
        ...
        <a href="{{url('/')}}" class="navbar-brand me-lg-5">
            <img src="{{url(session()->get('language') == 'en' ? websiteSettings()->logo : websiteSettings()->default_user_cover)}}" alt="logo" class="logo-dark" height="22"/>
        </a>
                ...
                @if (Route::has('login'))
                    ...
                    @else
                        <li class="nav-item me-0">
                            ...
                            <a href="{{ route('login') }}"
                               class="btn btn-sm btn-light rounded-pill d-none d-lg-inline-flex">
                                <i class="mdi mdi-lock me-2"></i> Log In
                            </a>
                        ...
                        @if (Route::has('register'))
                            <li class="nav-item me-0">
                                ...
                                <a href="{{ route('register') }}"
                                   class="btn btn-sm btn-light rounded-pill d-none d-lg-inline-flex">
                                    <i class="mdi mdi-github me-2"></i> Register
                                </a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 offset-md-2">
                <div class="text-md-end mt-3 mt-md-0">
                    <img src="{{url('backend')}}/assets/images/svg/startup.svg" alt="" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mt-1">
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-1.png" alt="demo-img"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-2.png" alt="demo-img"
                         class="img-fluid shadow-sm rounded">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-3.png" alt="demo-img"
                         class="img-fluid shadow-sm rounded">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-5.png" alt="demo-img"
                         class="img-fluid shadow-sm rounded">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-6.png" alt="demo-img"
                         class="img-fluid shadow-sm rounded">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box text-center mt-3">
                    <img src="{{url('backend')}}/assets/images/layouts/layout-4.png" alt="demo-img"
                         class="img-fluid shadow-sm rounded">
    ...
    <div class="container">
        ...
        <div class="row mt-2 py-5 align-items-center">
            <div class="col-lg-5 col-md-6">
                <img src="{{url('backend')}}/assets/images/svg/features-1.svg" class="img-fluid" alt="">
            </div>
        ...
        <div class="row pb-3 pt-5 align-items-center">
            <div class="col-lg-6 col-md-5">
                ...
                <p class="text-muted mt-3">The simplest and fastest way to build dashboard or admin panel. Hyper is
                    built using the latest tech and tools and provide an easy way to customize anything, including an
                    overall color schemes, layout, etc.</p>

                <div class="mt-4">
                    <p class="text-muted"><i class="mdi mdi-circle-medium text-success"></i> Built with latest Bootstrap
                    </p>
            ...
            <div class="col-lg-5 col-md-6 offset-md-1">
                <img src="{{url('backend')}}/assets/images/svg/features-2.svg" class="img-fluid" alt="">
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-5 offset-lg-1">
                ...
                <div>
                    ...
                    <p class="faq-answer mb-4 pb-1 text-muted">Use our dedicated support email (support@coderthemes.com)
                        to send your issues or feedback. We are here to help anytime.</p>
                </div>
...
<section class="py-5 bg-light-lighten border-top border-bottom border-light">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center">
                    ...
                    <p class="text-muted mt-2">Please fill out the following form and we will get back to you shortly.
                        For more
                        <br>information please contact us.</p>
                </div>
            </div>
        ...
        <div class="row align-items-center mt-3">
            <div class="col-md-4">
                <p class="text-muted"><span class="fw-bold">Customer Support:</span><br> <span class="d-block mt-1">+1 234 56 7894</span>
                </p>
                <p class="text-muted mt-4"><span class="fw-bold">Email Address:</span><br> <span class="d-block mt-1">info@gmail.com</span>
                </p>
                <p class="text-muted mt-4"><span class="fw-bold">Office Address:</span><br> <span class="d-block mt-1">4461 Cedar Street Moro, AR 72368</span>
                </p>
                <p class="text-muted mt-4"><span class="fw-bold">Office Time:</span><br> <span class="d-block mt-1">9:00AM To 6:00PM</span>
                </p>
            </div>
...
<footer class="bg-dark py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <img src="{{url('backend')}}/assets/images/logo.png" alt="logo" class="logo-dark" height="22"/>
